...
def mouse_wheel(new_x, new_y,num,times=0):
    time.sleep(1)
...
def mouse_right_click(new_x=None, new_y=None, times=1):
    mouse_move(new_x, new_y)
    time.sleep(0.05)
    while times:
...
def mouse_left_click_move(start_x=None, start_y=None,end_x=None, end_y=None):
    time.sleep(0.05)
